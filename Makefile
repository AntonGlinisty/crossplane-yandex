...
XPKGS = provider-yandex
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-yandex: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Yandex CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Yandex controllers
...
# This target prepares repo for your provider by replacing all "yandex"
